...
//   
//   def add(superTypeName:String, newType:KnownType):TypeTree =
//     findTree(superTypeName) match {
...
//       }
//   
//   def complies(expected:TypeExpr, given:TypeExpr):List[TypeCompliance] =
...
//     }
//   
//   def deepestCommonAncestor(a:Type, b:Type):Type =
//       (a, b) match {
